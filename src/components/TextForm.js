    ...
    return (
        <>
            <div className="container" style={{ color: props.mode === 'dark' ? 'white' : '#042743' }}>
                ...
                <button disabled={text.length === 0} className="btn btn-dark mx-1 my-1" onClick={HandleTBClick}  >Convert to Binary</button>
                <button disabled={text.length === 0} className="btn btn-dark mx-1 my-1" onClick={HandleBTClick}  >Convert to Text</button>
